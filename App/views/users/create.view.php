    ...
    <div class="bg-white p-8 rounded-lg shadow-md w-full md:w-500 mx-6">
        ...
        <form method="POST" action="/auth/register">
            <div class="mb-4">
                ...
                <div class="message bg-red-100 my-3"> <?= $errors['name'] ?? '' ?> </div>
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <div class="message bg-red-100 my-3"> <?= $errors['password'] ?? '' ?> </div>
            </div>
            <div class="mb-4">
                ...
                <div class="message bg-red-100 my-3"> <?= $errors['password_confirmation'] ?? '' ?> </div>
            </div>
